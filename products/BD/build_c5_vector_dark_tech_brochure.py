...
PDF_NAME = "FMC3_C5_Brochure_Deutsch_Redesigned_2_HighRes_Vector_dark_tech.pdf"
...
def planning_payloads() -> list[dict]:
    specs = [
        ...
        ("content", "cta", PAGE_TEXT[6][1], "Projektablauf und Serviceversprechen in eine Live-Demo-Einladung überführen.", "image42.jpeg", "timeline", "l-shape", "收束"),
    ]
    payloads = []
...
.subhead{{margin-top:12px;color:var(--muted);font-size:19px;line-height:1.48}} .body{{color:var(--muted);font-size:15px;line-height:1.55}}
...
.cover-kpis{display:grid;grid-template-columns:repeat(3,1fr);margin-top:28px;height:132px}.cover-kpis div{padding:24px 30px;border-right:1px solid rgba(255,255,255,.14)}.cover-kpis div:last-child{border-right:0}.cover-kpis strong{display:block;font-size:31px}.cover-kpis span{display:block;margin-top:10px;color:var(--muted);font-size:13px}
.cover-company{margin-top:24px;display:flex;gap:22px;align-items:center;color:var(--faint);font-size:13px}.cover-company strong{color:var(--white);font-size:15px}
</style>"""
...
.scenarios-title{{margin-top:22px}} .scenarios-title h3,.floor-title h3{{color:var(--cyan);font-size:14px;letter-spacing:.05em}} .scenario-grid{{display:grid;grid-template-columns:repeat(3,1fr);gap:10px 14px;margin-top:13px}} .scenario{{height:68px;padding:12px 17px;display:flex;align-items:center;gap:12px}} .scenario img{{width:32px;height:32px;object-fit:contain;filter:brightness(0) saturate(100%) invert(79%) sepia(86%) saturate(1032%) hue-rotate(139deg) brightness(101%) contrast(89%)}} .scenario strong{{font-size:13px}}
.floor-title{{margin-top:18px}} .floors{{display:grid;grid-template-columns:repeat(5,1fr);gap:10px;margin-top:12px}} .floors span{{padding:11px 5px;text-align:center;border:1px solid var(--line);border-radius:7px;color:var(--muted);font-size:11px}}
</style>"""
...
<style>
h1{font-size:45px}.subhead{font-size:16px}.roi-kpis{display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-top:22px}.roi-kpi{height:190px;padding:20px;text-align:center}.roi-kpi .icon{width:35px;height:35px}.roi-kpi strong{display:block;font-size:31px;margin-top:12px}.roi-kpi span{display:block;color:var(--muted);font-size:11px;font-weight:700;line-height:1.45;margin-top:10px}
.comparison{margin-top:16px;padding:18px 22px}.comparison h3,.calculator>h3{color:var(--cyan);font-size:15px}.bar-row{display:grid;grid-template-columns:145px 1fr 90px;gap:15px;align-items:center;margin-top:15px;font-size:13px}.bar{height:11px;border-radius:5px;background:#8b96a8}.bar.c5{width:61%;background:var(--cyan)}.bar-row strong{text-align:right;font-size:16px}
.calculator{margin-top:16px;padding:20px}.calc-grid{display:grid;grid-template-columns:.86fr 1.14fr;gap:16px;margin-top:14px}.input-card,.machine-cost,.saving,.mini-compare,.result-pair>div{border:1px solid rgba(255,255,255,.14);border-radius:7px}.input-card{padding:13px}.input-title{display:flex;align-items:center;gap:10px}.input-title .icon{width:30px;height:30px}.input-title strong{font-size:14px}.input-title small{display:block;color:var(--muted);font-size:9px}.slider{position:relative;margin-top:13px}.slider b,.slider strong{font-size:10px}.slider strong{float:right;color:var(--cyan)}.slider i{display:block;position:relative;height:3px;background:rgba(255,255,255,.25);margin-top:7px}.slider i:before{content:'';display:block;width:var(--p);height:3px;background:var(--cyan)}.slider small{display:flex;justify-content:space-between;color:var(--faint);font-size:8px;margin-top:5px}.machine-cost{display:flex;gap:10px;padding:12px;margin-top:10px}.machine-cost .icon{width:29px;height:29px}.machine-cost strong{font-size:12px}.machine-cost p{font-size:9px;margin-top:8px;color:var(--muted)}.machine-cost b{float:right;color:var(--cyan)}
.saving{text-align:center;padding:17px;background:rgba(34,211,238,.08)}.saving span,.result-pair span{display:block;color:var(--muted);font-size:9px;font-weight:700}.saving strong{display:block;color:var(--cyan);font-size:37px;margin-top:8px}.saving small{font-size:11px}.mini-compare{padding:12px;margin-top:10px}.mini-compare h4{font-size:10px;color:var(--muted)}.mini-compare p{font-size:9px;margin-top:8px}.mini-compare p b{float:right}.mini-compare i{display:block;height:4px;margin-top:4px;background:#8b96a8;border-radius:3px}.mini-compare i.c5{width:61%;background:var(--cyan)}.result-pair{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:10px}.result-pair>div{text-align:center;padding:11px}.result-pair strong{display:block;margin-top:6px;font-size:16px}.offer{margin-top:10px;background:var(--cyan);color:#04111e;text-align:center;padding:10px;border-radius:6px;font-size:12px;font-weight:800}
.basis{margin-top:15px;padding:15px 20px;display:grid;grid-template-columns:190px 1fr;gap:8px 15px;align-items:center}.basis strong{font-size:12px}.basis span{color:var(--muted);font-size:10px}.basis small{grid-column:2;color:var(--faint);font-size:9px}
</style>"""
...
<style>
h1{{font-size:43px}} .subhead{{font-size:16px}} .company-grid{{display:grid;grid-template-columns:1.65fr 1fr;gap:16px;margin-top:22px}} .about{{height:282px;padding:25px}} .about h2{{font-size:23px}} .about p{{color:var(--muted);font-size:13px;line-height:1.52;margin-top:16px}} .facts{{height:282px;display:grid;grid-template-columns:1fr 1fr}} .facts div{{padding:23px;border-right:1px solid rgba(255,255,255,.13);border-bottom:1px solid rgba(255,255,255,.13)}} .facts div:nth-child(2n){{border-right:0}} .facts div:nth-child(n+3){{border-bottom:0}} .facts strong{{display:block;font-size:20px}} .facts span{{display:block;color:var(--muted);font-size:9px;font-weight:700;margin-top:17px}}
.team-title{{margin-top:20px}} .team-title h3{{color:var(--cyan);font-size:14px}} .team-grid{{display:grid;grid-template-columns:repeat(5,1fr);gap:10px;margin-top:12px}} .person{{height:640px;padding:17px 13px;text-align:center}} .person img{{width:116px;height:116px;border-radius:50%;object-fit:cover;border:2px solid var(--cyan);background:#fff}} .person h3{{font-size:14px;min-height:38px;margin-top:11px;display:flex;align-items:center;justify-content:center}} .person>span{{display:block;margin:11px auto 0;padding:8px 4px;border-radius:6px;background:rgba(255,255,255,.08);color:var(--cyan);font-size:10px;font-weight:800}} .person p{{margin-top:16px;text-align:left;color:var(--muted);font-size:11px;line-height:1.54}}
.local{{margin-top:18px;padding:19px 20px;text-align:center;background:rgba(34,211,238,.11)}} .local strong{{font-size:14px}} .local span{{display:block;color:var(--muted);font-size:11px;margin-top:9px}} .local div{{display:grid;grid-template-columns:repeat(3,1fr);margin-top:11px;font-size:10px}}
</style>"""
...
<section class="service-layout">
  ...
  <div><div class="section-rule"><h3>SERVICEVERSPRECHEN</h3><div class="line"></div></div><div class="promise-list">{promise_html}</div>
    ...
    <div class="robot-frame"><img class="robot" src="../images/image42.jpeg" alt="FMC3 C5"></div>
  </div>
</section>
<section class="contact panel"><span>Ihr Ansprechpartner</span><strong>Wang Haoan</strong><b>FMC3 Robotics</b><small>Ingolstadt · Deutschland</small></section>
<style>
h1{{font-size:48px}} .subhead{{max-width:800px;font-size:17px}} .service-layout{{display:grid;grid-template-columns:1.08fr .92fr;gap:52px;margin-top:27px}} .section-rule h3{{color:var(--cyan);font-size:14px}} .timeline{{position:relative;margin-top:24px}} .timeline:before{{content:'';position:absolute;left:43px;top:38px;bottom:50px;width:2px;background:linear-gradient(var(--cyan),rgba(99,102,241,.6))}}
.step{{position:relative;display:grid;grid-template-columns:86px 34px 1fr;gap:11px;align-items:start;min-height:142px}} .step-icon{{z-index:2;width:66px;height:66px;border-radius:50%;display:flex;align-items:center;justify-content:center;background:linear-gradient(145deg,var(--cyan),var(--violet));box-shadow:0 0 24px rgba(34,211,238,.2)}} .step-icon img{{width:34px;height:34px;object-fit:contain;filter:brightness(0) saturate(100%)}} .step>b{{color:var(--cyan);font-size:25px;padding-top:18px}} .step h3{{font-size:16px;padding-top:15px}} .step p{{color:var(--muted);font-size:13px;line-height:1.5;margin-top:9px;padding-bottom:16px;border-bottom:1px solid rgba(255,255,255,.13)}}
.promise-list{{display:grid;gap:12px;margin-top:24px}} .promise{{height:91px;padding:15px 20px;display:flex;align-items:center;gap:18px}} .promise strong{{font-size:16px;line-height:1.3}} .live{{margin-top:15px;padding:18px;display:flex;gap:19px;border-color:rgba(34,211,238,.65)}} .live .icon{{width:50px;height:50px}} .live h2{{font-size:23px;color:var(--cyan)}} .live p{{color:var(--muted);font-size:11px;line-height:1.5;margin-top:10px}} .robot-frame{{position:relative;width:295px;height:270px;margin:13px auto 0;overflow:hidden;background:#fff}} .robot{{position:absolute;top:0;left:50%;width:auto;height:100%;max-width:none;transform:translateX(-31.5%)}}
.contact{{position:absolute;left:66px;bottom:92px;width:390px;padding:20px 24px}} .contact span{{display:block;color:var(--cyan);font-size:12px;font-weight:700}} .contact strong{{display:block;font-size:25px;margin-top:13px}} .contact b{{display:block;font-size:14px;margin-top:13px}} .contact small{{display:block;color:var(--muted);font-size:12px;margin-top:9px}}
</style>"""
...
def content_audit(
    ...
    missing_source = [
        ...
        if normalize_text(segment).rstrip("-") not in all_html
    ]
    missing_pages = {
        str(page): [
    ...
    return {
        ...
        "note": "All 42 embedded media files are copied byte-identically; source textbox text is audited directly from document.xml.",
    }
